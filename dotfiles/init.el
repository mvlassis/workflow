...
;; Theme to load
(if (locate-file "doom-vibrant-theme.el" custom-theme-load-path)
    (load-theme 'doom-vibrant t)
  (if (locate-file "modus-vivendi-theme.el" custom-theme-load-path)
