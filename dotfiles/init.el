...
(custom-set-variables
 ...
 '(package-selected-packages
   '(hyprlang-ts-mode dockerfile-mode pyvenv-auto pyvenv exec-path-from-shell terraform-mode gnu-elpa-keyring-update consult zenburn-theme yaml-mode xclip which-key vterm vertico use-package sudo-edit snap-indent reverse-im restart-emacs rainbow-mode rainbow-delimiters quelpa monokai-theme math-preview material-theme marginalia lsp-ui lsp-pyright keycast kaolin-themes ini-mode gruvbox-theme flycheck evil esup elpy ein eat dracula-theme doom-themes doom-modeline dap-mode cyberpunk-theme clipetty benchmark-init auto-package-update auctex arduino-mode anzu all-the-icons)))
(custom-set-faces
