...
-- Modified by mvlassis to add the total amount of non-transparent pixels
...
if (not cancel) then
	...
	-- Also calculate the non-transparent pixels
	local nonTransparentPixelSum = 0
	for i=1, #pixelStuff do
		nonTransparentPixelSum = nonTransparentPixelSum + pixelStuff[i][2]
	end
	...
	print("Total amount of non-transparent pixels: "..nonTransparentPixelSum)
